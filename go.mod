...
require (
	github.com/AustralianCyberSecurityCentre/azul-bedrock/v9 v9.0.4
...
// replace github.com/AustralianCyberSecurityCentre/azul-bedrock/v9 v8.0.19 => ../../azul-core/azul-bedrock
